...
static uint8_t readU8(std::ifstream& file) { return readValue<uint8_t>(file, readUInt8); }

static int16_t readS16(std::ifstream& file) { return readValue<int16_t>(file, readInt16); }

static uint32_t readU32(std::ifstream& file) { return readValue<uint32_t>(file, readUInt32); }

static int32_t readS32(std::ifstream& file) { return readValue<int32_t>(file, readInt32); }
